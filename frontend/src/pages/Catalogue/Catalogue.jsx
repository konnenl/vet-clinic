...
export default function Catalogue() {
  const services = [
    ...
    {title:'Узи', count: 6, src:"https://optim.tildacdn.com/tild6464-3865-4636-a539-326534636631/-/resize/460x/-/format/webp/noroot.png.webp"},
    ...
    {title:'Прием специалиста', count: 5, src:"https://optim.tildacdn.com/tild3439-6366-4232-b935-333932343765/-/resize/426x/-/format/webp/noroot.png.webp"},
